...
import type { newsInfo } from "@src/types/entities/newsInfo";

export const newsList = map<newsInfo[]>([
  {
    id: 1,
...
export const latestNews = computed(newsList, newsValue => {
  return newsValue.sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt)).slice(0, 3);
})